	...
	implements vscode.WebviewViewProvider, vscode.Disposable
{
	 ...
	 * either underlying signal (`signedIn`, or `hasApiKey` — which despite its
	 * name covers any usable LLM credential: Anthropic, Jolli proxy,
	 * local-agent, or Azure Foundry) flips. Drives the onboarding-panel vs
	 * main-UI split in the webview.
	 */
	...
	/** Mirrors {@link notifyApiKeySaveError}, for the inline Azure endpoint save. */
	notifyAzureConfigSaveError(message: string): void {
		this.postMessage({ type: "azure:saveError", message });
	}
